      ...
      <div class="card">
        ...
        <div class="community">
          ...
          <el-tooltip
            class="item"
            effect="dark"
            content="xiao13022087579@163.com"
            placement="top"
          >
            <a class="iconfont icon-youxiang"></a>
          </el-tooltip>
          <el-tooltip
            class="item"
            effect="dark"
          ...
          >
            <a
              ...
              href="https://github.com/KevinLin8"
              target="_blank"
            ></a>
          </el-tooltip>
          ...
          <el-tooltip
            ...
            placement="top"
          >
            <a class="iconfont icon-zhihu-circle-fill"></a>
          </el-tooltip>
          <el-tooltip
            class="item"
            effect="dark"
          ...
          <el-tooltip
            ...
            placement="top"
          >
            <a class="iconfont icon-icon_bilibili-square"></a>
          </el-tooltip>
        </div>
      </div>
    </div>
    <div class="vxcard Fillet_corner">
...
.side {
  ...
  .author_info {
    ...
    .icon {
      ...
      background-image: url("../assets/imges/avatar.jpg");
